...
namespace merai
{
    ...
    inline SyncType parseSyncType(const std::string &typeStr)
    {
        auto t = toLowerCopy(typeStr);
        if (t == "rxpdo")
            return SyncType::RxPdo;
        if (t == "txpdo")
            return SyncType::TxPdo;
    ...
    inline PdoDataType parsePdoDataType(const std::string &dtStr)
    {
        ...
        if (t == "int8")
            return PdoDataType::Int8;
        if (t == "int16")
            return PdoDataType::Int16;
        if (t == "int32")
            return PdoDataType::Int32;
        if (t == "uint16")
            return PdoDataType::UInt16;
        if (t == "uint32")
            return PdoDataType::UInt32;

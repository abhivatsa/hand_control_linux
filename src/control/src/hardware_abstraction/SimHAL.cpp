...
namespace seven_axis_robot
{
    namespace control
    {
              ...
              loggerMem_(loggerMem)
        {
            if (!rtLayout_)
            {
                seven_axis_robot::merai::log_warn(loggerMem_, "Control", 2300, "[SimHAL] Warning: Null rtLayout");
            }
            if (!paramServerPtr_)
            {
                seven_axis_robot::merai::log_warn(loggerMem_, "Control", 2301, "[SimHAL] Warning: Null ParameterServer");
            }
        }
        ...
        bool SimHAL::init()
        {
            ...
            seven_axis_robot::merai::log_info(loggerMem_, "Control", 2302, "[SimHAL] init() complete");
            return true;
        }

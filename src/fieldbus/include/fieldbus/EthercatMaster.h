...
namespace fieldbus
{
    ...
    public:
         ...
         */
        EthercatMaster(const std::string& paramServerShmName, std::size_t paramServerShmSize,
    ...
    private:
        ...
        // Local shadow of servo Rx PDOs (commands from control)
        std::array<merai::ServoRxPdo, merai::MAX_SERVO_DRIVES> servoRxShadow_{};
    };

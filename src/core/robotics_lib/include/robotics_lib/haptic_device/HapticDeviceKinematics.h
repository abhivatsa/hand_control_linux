    ...
    namespace robotics
    {
        namespace haptic_device
        {
            ...
            public:
                 ...
                 */
                int forwardKinematics(const seven_axis_robot::math::Vector<6> &jointAngles,
                 ...
                 * @return int          0 if success, non-zero if there's an error
                 */
                int computeJacobian(const seven_axis_robot::math::Vector<6> &jointAngles,
                 ...
                 *                            or out of range
                 */
                int computeInverseKinematics(const seven_axis_robot::math::Vector<6> &currentJointAngles,
            ...
            private:
                ...
                seven_axis_robot::math::Matrix<4, 4> buildHomogeneousTransform(
                ...
                seven_axis_robot::math::Matrix<3, 3> axisAngleRotation(
